...
class ParticipantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participante" do
    assert_difference('Participante.count') do
      post participantes_url, params: { participante: { cidade: @participante.cidade, cpf: @participante.cpf, data_nascimento: @participante.data_nascimento, estado: @participante.estado, nome_completo: @participante.nome_completo, rg: @participante.rg } }
    end
  ...
  test "should update participante" do
    patch participante_url(@participante), params: { participante: { cidade: @participante.cidade, cpf: @participante.cpf, data_nascimento: @participante.data_nascimento, estado: @participante.estado, nome_completo: @participante.nome_completo, rg: @participante.rg } }
